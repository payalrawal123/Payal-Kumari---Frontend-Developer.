    ...
    <div className="map">
      ...
      <div className="phase1">
        <div className="flex1">
          ...
          <p className="phase-p">Kicking Off</p>
          <div class="icon-text">
            <svg
            ...
            <p class="p2">Launch of EthAi: Officially</p>
          </div>
          <div class="icon-text">
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <p class="p2">Development of Core AI Agents</p>
          </div>
          <div class="icon-text">
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <p class="p2">User Onboarding Campaign</p>
          </div>
          <div class="icon-text">
            <svg
              xmlns="http://www.w3.org/2000/svg"
